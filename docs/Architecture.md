...
This boundary is what made the Phase 5 risk audit tractable. Most of the "can the client cheat?" questions had a fast, confident answer, because the boundary had already been drawn correctly during Phase 4 instead of being retrofitted afterward.
